...
const CATEGORY_MAP = {
  'Food & Drink': {
    ...
    description: 'restaurants, bars, cafes, and bakeries only',const SUPABASE_URL = import.meta.env.VITE_SUPABASE_URL;
...
/**
 * Search Google Places via Supabase Edge Function proxy.
 * The edge function handles the actual Google API call server-side
 ...
 * Ensures results are actually in the searched neighborhood.
 */
